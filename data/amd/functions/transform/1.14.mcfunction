...
execute if entity @s[type=!#amd:undead/1.14] run summon minecraft:potion ~ ~ ~ {Motion:[0.0,0.5,0.0],Potion:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:strong_healing"}}}
execute if entity @s[type=!#amd:undead/1.14] run summon minecraft:potion ~ ~ ~ {Motion:[0.0,0.5,0.0],Potion:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:strong_healing"}}}
execute if entity @s[type=#amd:undead/1.14] run summon minecraft:potion ~ ~ ~ {Motion:[0.0,0.5,0.0],Potion:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:strong_harming"}}}
execute if entity @s[type=#amd:undead/1.14] run summon minecraft:potion ~ ~ ~ {Motion:[0.0,0.5,0.0],Potion:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:strong_harming"}}}
