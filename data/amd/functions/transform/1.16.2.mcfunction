...
# Called by: core/tick/second/1.16.2
# Datapack by 2mal3
...
data merge entity @s[tag=!global.ignore.gui,type=minecraft:piglin_brute] {CustomName:'[{"text":"Advanced: ","color":"red"},{"text":"Piglin Brute","color":"white"}]'}
